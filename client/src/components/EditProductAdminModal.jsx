...
const EditProductAdmin = ({ close, userData, fetchProducts }) => {
  ...
  return (
    <div className="fixed top-0 px-4 left-0 w-full h-full bg-black bg-opacity-30 flex items-center justify-center z-50">
      <div className="bg-white w-full max-w-lg rounded p-4 mx-auto overflow-y-auto h-full max-h-[98vh] scrollBarNone">
        <div className="flex items-center gap-2 justify-between">
          <h1 className="font-bold">Edit Product</h1>
          <IoClose onClick={close} size={25} className="cursor-pointer" />
        </div>
